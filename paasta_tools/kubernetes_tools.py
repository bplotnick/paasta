...
class KubeClients(object):
    def get_current_client_for_service(self, job_config: KubernetesDeploymentConfig) -> KubeClient:
        return KubeClient()


def get_kubernetes_clients() -> KubeClients:
    return KubeClients()
